...
def proposal_to_envelope(
    ...
    *,
    ...
    envelope = {
        ...
        "reviewer_identity_verified": policy_result.get("reviewer_identity_verified", False),
        "reviewer_identity_errors": policy_result.get("reviewer_identity_errors", []),
        "reviewer_identity_hash": policy_result.get("reviewer_identity_hash"),
        "reviewer_registry_version": policy_result.get("reviewer_registry_version"),
        "reviewer_issuer_id": policy_result.get("reviewer_issuer_id"),
